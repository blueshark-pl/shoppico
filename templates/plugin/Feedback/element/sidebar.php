...
if($this->request->getAttribute('identity')->email) {
    $name = $this->request->getAttribute('identity')->username ?: $this->request->getAttribute('identity')->username ?: '';
	$email = $this->request->getAttribute('identity')->email ?: $this->request->getAttribute('identity')->email ?: '';
}else{
    $name = '';
	$email = '';

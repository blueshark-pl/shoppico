 ...
 * @var string[]|\Cake\Collection\CollectionInterface $filters
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $filterDetail->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $filterDetail->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="filterDetails form content">
            ...
            <fieldset>
                <legend><?= __('Edit Filter Detail') ?></legend>
                <?php
